...
### Super Missile Doors
  ...
  - **Sky Temple Grounds: Shrine Access - Gateway Access** (note: super door is on side of Gateway Access, but is normally destroyed by opening seeker door)
